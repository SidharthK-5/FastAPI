...
def test_person_initialization():
    ...
    assert p.first_name == "John", "First nam should be John"
...
def test_person_initialization_fixture(default_employee):
    assert default_employee.first_name == "John", "First nam should be John"
